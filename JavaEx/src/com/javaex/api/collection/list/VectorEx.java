...
public class VectorEx {
	...
	public static void main(String[] args) {
		...
		System.out.println("Size" + v.size() + 
				", Capacity:" + v.capacity()); // Size0, Capacity:10
		...
		System.out.println("Size" + v.size() + 
				", Capacity:" + v.capacity());	//	Size10, Capacity:10
		
		v.addElement(11);	//	허용량 자동 증가
		System.out.println("Size" + v.size() + 
				", Capacity:" + v.capacity()); // Size11, Capacity:20
		
		System.out.println("v :" + v);
		
		v.insertElementAt(12, 5); //	12객체를 5번 인덱스에 추
		...
		System.out.println("v :" + v);
		System.out.println("Size" + v.size() + 
				", Capacity:" + v.capacity()); // Size0, Capacity:20
