...
//		usefulMethods();
	...
	//	문자열 객체 : 연결, 메서드 수행시 매번 새 String 변환
	//	StringBuffer : 버퍼 기반으로 작
	private static void stringBufferEx() {
		...
		//	StringBuffer의 매서드들은 연속해서 호출 -> 메서드 체이닝
	...
	private static void usefulMethods() {
		...
		System.out.println("substring:" + str.substring(5, 16));	// 	5 ~ 16-1까
		...
		//	문자열 비교: Unicode 비교
		//	같으면 0, 앞의 것이 작으면(먼저) 음수, 앞의 것이 크면(뒤면) 양
