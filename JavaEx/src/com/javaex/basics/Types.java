...
public class Types {
	...
	private static void constantEx() {
		...
		//SPEED_LIMIT = 80; // 내부에서 고의로든 실수로든 변경면 안되는 값 -> 상
	...
	private static void charEx() {
		...
		System.out.println(ch1 + ch2); // 정수코드값이 합산된 정수가 나온다. 
									   //컴퓨터 입장에서는 문자가 숫자
		// 문자열은 쌍따옴표로(")
		String str = "Java";
	...
	private static void floatTypes() {
		float floatVar = 3.12345F; // F or f
	...
	private static void integerTypes() {
		...
		// 초기화
		intVar1 = 2021;
		//intVar2 = 12345678901234; -> Error : 범위초
		...
		// 정수형 데이터의 기본은 int
		longVar1 = 2021;
		longVar2 = 12345678901234L; // 뒤에L or l -> long 형임을 알림
