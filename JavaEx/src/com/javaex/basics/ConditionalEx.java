...
//		switchEx2();
	...
	private static void switchEx3() {
		//	코드 값을 문자열로 전달하는 경우
		//	-> 오타 발생 가능, 원하지않는 입력이 넘어오는 경우가 있다
		//	코드의 집합을 별도 선언, 입력 값을 제한해야 한다
		// -> TODO: enum 열거형으로 재작성을 해 볼 
		String day = "MONDAY";
		String act = "";
	...
	private static void switchEx2() {
		...
		case 2:
			...
			break;
		default:
			System.out.println("다른요일을 입력하세요");
		}
		scanner.close();
		
	}
	private static void switchEx() {
		//	ifElseEx3 를 switch ansdmfh aksemfdj qhqtlek.
		Scanner scanner = new Scanner(System.in);
		System.out.print("과목 1. Java 2. C, 3. C++ 4. 파이썬");
		int subject = scanner.nextInt();
		
		// switch ~ case 문으로 구현
		// 특별한 경우가 아니면 case문과 break 문 쌍으로 생각하자
		switch(subject) {
		case 1: //	subject == 1
